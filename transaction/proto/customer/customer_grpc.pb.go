...
const (
	CustomerService_AddProduct_FullMethodName       = "/customer.CustomerService/AddProduct"
...
type CustomerServiceClient interface {
	AddProduct(ctx context.Context, in *Customer, opts ...grpc.CallOption) (*CustomerResponse, error)
	FindCustomerByID(ctx context.Context, in *CustomerQueryRequest, opts ...grpc.CallOption) (*CustomerResponse, error)
	GetAllCustomers(ctx context.Context, in *CustomerQueryRequest, opts ...grpc.CallOption) (*CustomerListResponse, error)
}
...
func (c *customerServiceClient) AddProduct(ctx context.Context, in *Customer, opts ...grpc.CallOption) (*CustomerResponse, error) {
	out := new(CustomerResponse)
	err := c.cc.Invoke(ctx, CustomerService_AddProduct_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *customerServiceClient) GetAllCustomers(ctx context.Context, in *CustomerQueryRequest, opts ...grpc.CallOption) (*CustomerListResponse, error) {
...
type CustomerServiceServer interface {
	AddProduct(context.Context, *Customer) (*CustomerResponse, error)
	FindCustomerByID(context.Context, *CustomerQueryRequest) (*CustomerResponse, error)
	GetAllCustomers(context.Context, *CustomerQueryRequest) (*CustomerListResponse, error)
...
func (UnimplementedCustomerServiceServer) AddProduct(context.Context, *Customer) (*CustomerResponse, error) {
...
func (UnimplementedCustomerServiceServer) GetAllCustomers(context.Context, *CustomerQueryRequest) (*CustomerListResponse, error) {
...
func _CustomerService_AddProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Customer)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CustomerServiceServer).AddProduct(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CustomerService_AddProduct_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerServiceServer).AddProduct(ctx, req.(*Customer))
	}
...
func _CustomerService_GetAllCustomers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerServiceServer).GetAllCustomers(ctx, req.(*CustomerQueryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _CustomerService_AddProduct_Handler,
		},
		{
