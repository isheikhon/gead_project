...
var file_transaction_transaction_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xe9, 0x01, 0x0a, 0x0b, 0x54, 0x72, 0x61, 0x6e,
	...
	0x64, 0x41, 0x74, 0x22, 0x54, 0x0a, 0x16, 0x41, 0x64, 0x64, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61,
	...
	0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x59, 0x0a, 0x1b, 0x46, 0x69, 0x6e,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0x59, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x54, 0x72,
...
var file_transaction_transaction_proto_goTypes = []interface{}{
	...
	(*GetAllTransactionRequest)(nil),    // 1: transaction.GetAllTransactionRequest
	...
	(*GetAllTransactionResponse)(nil),   // 5: transaction.GetAllTransactionResponse
...
var file_transaction_transaction_proto_depIdxs = []int32{
	...
	2, // 3: transaction.GetAllTransactionResponse.transactions:type_name -> transaction.Transaction
	...
	1, // 6: transaction.TransactionService.GetAllTransaction:input_type -> transaction.GetAllTransactionRequest
	...
	5, // 9: transaction.TransactionService.GetAllTransaction:output_type -> transaction.GetAllTransactionResponse
