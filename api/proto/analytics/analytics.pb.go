...
func (x *TotalSalesResponse) Reset() {
	*x = TotalSalesResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *TotalSalesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TotalSalesResponse) ProtoMessage() {}

func (x *TotalSalesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_analytics_analytics_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TotalSalesResponse.ProtoReflect.Descriptor instead.
func (*TotalSalesResponse) Descriptor() ([]byte, []int) {
	return file_analytics_analytics_proto_rawDescGZIP(), []int{6}
}

func (x *TotalSalesResponse) GetSales() *TotalSales {
	if x != nil {
		return x.Sales
	}
	return nil
...
func (x *TopCustomerResponse) Reset() {
	*x = TopCustomerResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *TopCustomerResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TopCustomerResponse) ProtoMessage() {}

func (x *TopCustomerResponse) ProtoReflect() protoreflect.Message {
	mi := &file_analytics_analytics_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TopCustomerResponse.ProtoReflect.Descriptor instead.
func (*TopCustomerResponse) Descriptor() ([]byte, []int) {
	return file_analytics_analytics_proto_rawDescGZIP(), []int{7}
}

func (x *TopCustomerResponse) GetCustomers() []*Customer {
	if x != nil {
		return x.Customers
	}
	return nil
...
func (x *ProductSalesResponse) Reset() {
	*x = ProductSalesResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProductSalesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProductSalesResponse) ProtoMessage() {}

func (x *ProductSalesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_analytics_analytics_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProductSalesResponse.ProtoReflect.Descriptor instead.
func (*ProductSalesResponse) Descriptor() ([]byte, []int) {
	return file_analytics_analytics_proto_rawDescGZIP(), []int{8}
}

func (x *ProductSalesResponse) GetProducts() []*Product {
	if x != nil {
		return x.Products
	}
	return nil
...
var file_analytics_analytics_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x74, 0x22, 0x41, 0x0a, 0x12, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x53, 0x61, 0x6c, 0x65,
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2b, 0x0a, 0x05, 0x73, 0x61, 0x6c,
	0x65, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x61, 0x6e, 0x61, 0x6c, 0x79,
	0x74, 0x69, 0x63, 0x73, 0x2e, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x53, 0x61, 0x6c, 0x65, 0x73, 0x52,
	0x05, 0x73, 0x61, 0x6c, 0x65, 0x73, 0x22, 0x48, 0x0a, 0x13, 0x54, 0x6f, 0x70, 0x43, 0x75, 0x73,
	...
	,
	...
	0x69, 0x63, 0x73, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x53, 0x61, 0x6c, 0x65, 0x73,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x54, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x54,
	0x6f, 0x70, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73, 0x12, 0x21, 0x2e, 0x61, 0x6e,
	0x61, 0x6c, 0x79, 0x74, 0x69, 0x63, 0x73, 0x2e, 0x47, 0x65, 0x74, 0x54, 0x6f, 0x70, 0x43, 0x75,
	0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1e,
	0x2e, 0x61, 0x6e, 0x61, 0x6c, 0x79, 0x74, 0x69, 0x63, 0x73, 0x2e, 0x54, 0x6f, 0x70, 0x43, 0x75,
	0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x08,
...
var file_analytics_analytics_proto_goTypes = []interface{}{
	...
	(*TotalSalesResponse)(nil),       // 6: analytics.TotalSalesResponse
	(*TopCustomerResponse)(nil),      // 7: analytics.TopCustomerResponse
	(*ProductSalesResponse)(nil),     // 8: analytics.ProductSalesResponse
}
var file_analytics_analytics_proto_depIdxs = []int32{
	0, // 0: analytics.TotalSalesResponse.sales:type_name -> analytics.TotalSales
	1, // 1: analytics.TopCustomerResponse.customers:type_name -> analytics.Customer
	2, // 2: analytics.ProductSalesResponse.products:type_name -> analytics.Product
	...
	6, // 6: analytics.CustomerService.GetTotalSales:output_type -> analytics.TotalSalesResponse
	8, // 7: analytics.CustomerService.GetSalesByProduct:output_type -> analytics.ProductSalesResponse
	7, // 8: analytics.CustomerService.GetTopCustomers:output_type -> analytics.TopCustomerResponse
...
func file_analytics_analytics_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_analytics_analytics_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TotalSalesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_analytics_analytics_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TopCustomerResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_analytics_analytics_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProductSalesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
